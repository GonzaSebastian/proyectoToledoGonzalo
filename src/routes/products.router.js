...
productRouter.get('/', handlePolicies(["ADMIN", "USER", "PUBLIC"]), getProductsController)

productRouter.get("/:pid", handlePolicies(["ADMIN", "USER", "PUBLIC"]), getProductByIdController)
